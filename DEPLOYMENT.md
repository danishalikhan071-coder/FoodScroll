...
# For multiple frontend URLs, use comma-separated: https://app1.com,https://app2.com
...
1. **Backend CORS**: 
   - Set `CLIENT_URL` to your frontend deployment URL (e.g., `https://foodscroll.vercel.app`)
   - For multiple frontend URLs, use comma-separated: `https://app1.com,https://app2.com`
   - CORS automatically normalizes URLs (removes trailing slashes) for matching
   - Localhost origins are allowed by default for development
2. **Frontend API URL**: Set `VITE_API_URL` to your backend deployment URL (without trailing slash)
